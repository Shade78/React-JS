...
function sortProductsByPrice(products){
  return products.slice().sort((a, b) => a.price - b.price) // делаем копию массива и работаем с ним, вместо исходного
} // можно сделать через копию массива - copyOfArray = [...products]; copyOfArray.sort((a,b) => a.price - b.price)
